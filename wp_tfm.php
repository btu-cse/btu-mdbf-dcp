...
//Application Title
define('APP_TITLE', 'Tiny File Manager / dev');
...
$auth_users = array(
    'bmadmin' => '$2y$10$eCW.v/RPhTlB6wcbDZ2CCeQRPtTXZPFkHqoKDlwDnliBubI42PamG',
    'tfmadmin' => '$2y$10$eCW.v/RPhTlB6wcbDZ2CCeQRPtTXZPFkHqoKDlwDnliBubI42PamG'
);
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            if(isset($_GET['edit']))
            {
                $path_filename = '<i class="bread-crumb"> / </i>'.$_GET['edit'];
            }
            echo '<div class="col-xs-6 col-sm-5">' . $root_url . $path_filename . '</div>';
            ?>
...
<head>
    ...
    <style>
        ...
        .nav-link {color: rgba(150, 12, 12, 0.89) !important;}
        a { color: #4e3f9e !important;}
        .navbar{background-color: #bdb3bc !important; font-weight: bold !important;}
        a:hover, a:visited, a:focus { text-decoration:none !important; }
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        .filename, td, th { white-space:nowrap  }
        .navbar-brand { font-weight:bold; color:#6d508f !important; }
        .nav-item.avatar a { cursor:pointer;text-transform:capitalize; }
        .nav-item.avatar a > i { font-size:15px; }
        .nav-item.avatar .dropdown-menu a { font-size:13px; }
        #search-addon { font-size:12px;border-right-width:0; }
        #search-addon2 { background:transparent;border-left:0; }
        .bread-crumb { color:#9a1e1f;font-style:normal; font-weight: bold !important; }
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE): 
        ...
        if($ext == 'php')
        {
            $theme = 'tomorrow_night_eighties';//tomorrow_night_bright
        }
        else if($ext == 'css')
        {
            $theme = 'dracula';
    ...
    <script>
        ...
        /*$("#js-ace-mode").val("ace/mode/<?php echo $ext; ?>");*/

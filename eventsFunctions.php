...
function utt_event_scripts(){
    ...
    wp_localize_script( 'eventScripts', 'eventStrings', array(
        ...
        'deleteEvent' => __( 'Bu Etkinliği silmek istediğinize emin misiniz?', 'UniTimetable' ),
        'eventDeleted' => __( 'Event deleted successfully!', 'UniTimetable' ),
        'eventNotDeleted' => __( 'Etkinlik başarıyla silindi!', 'UniTimetable' ),
...
function utt_view_events(){
    ...
    <table class="widefat bold-th">
        <thead>
            <tr>
                <th><?php _e("Gün","UniTimetable"); ?></th>
                <th><?php _e("Tip","UniTimetable"); ?></th>
                <th><?php _e("Başlık","UniTimetable"); ?></th>
                <th><?php _e("Tanım","UniTimetable"); ?></th>
                <th><?php _e("Sınıf","UniTimetable"); ?></th>
                <th><?php _e("Başlangıç Saati","UniTimetable"); ?></th>
                <th><?php _e("Bitiş Saati","UniTimetable"); ?></th>

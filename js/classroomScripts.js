...
function editClassroom(classroomID,classroomName,classroomType,classroomCapacity,classroomAvailable) {
    ...
    document.getElementById('classroomCapacity').value=classroomCapacity;
    document.getElementById('classroomAvailable').value=classroomAvailable;
...
jQuery(function ($) {
    ...
    $('#insert-updateClassroom').click(function(){
        ...
        var classroomCapacity = $('#classroomCapacity').val();
        var classroomAvailable = $('#classroomAvailable').val();
        ...
        var data = {
            ...
            classroom_available: classroomAvailable
        };
        //ajax call

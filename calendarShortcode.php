...
function load_utt_calendar($attr){
    ...
    $sc= '<div id="filters">
        <span id="filter1">'
            .__("Filtrele: ","UniTimetable").
            '<select name="filterSelect1" id="filterSelect1">
                <option value="semester">'.__("Bölüm","UniTimetable").'</option>
                <option value="teacher">'.__("Öğretim Üyesi","UniTimetable").'</option>
                <option value="classroom" selected="selected">'.__("Derslik","UniTimetable").'</option>
            </select>
        </span>
        <span id="filter2">
            <select name="filterSelect2" id="filterSelect2" onchange="filterFunction();">
                <option value="0">'.__("- seç -","UniTimetable").'</option>';
                /*for($i=1;$i<8;$i++){
                    if($i==1){
		...
		<span id="filter3">
            <select name="filterSelect3" id="filterSelect3" onchange=\'filterFunction();\'>
                <option value="0" selected="selected">'. __("Tüm Sınıflar","UniTimetable").'</option>
                <option value="1">'. __("1. Sınıf","UniTimetable").'</option>
                <option value="2">'. __("2. Sınıf","UniTimetable").'</option>
                <option value="3">'. __("3. Sınıf","UniTimetable").'</option>
                <option value="4">'. __("4. Sınıf","UniTimetable").'</option>
            </select>
        </span>
